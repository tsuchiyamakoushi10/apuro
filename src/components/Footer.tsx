...
export function Footer() {
  return (
    <footer className="mx-8 rounded-t-panel bg-mist pb-11 pt-[76px] text-[12.5px] text-ink-muted max-[960px]:mx-4">
      ...
      <p className="wrap-panel mx-auto mt-11 max-w-[calc(var(--container-wrap)-64px)] font-en text-[10.5px] tracking-[0.1em] max-[960px]:px-6">
        © {site.nameEn}
      </p>
    </footer>
  );
