          ...
          <div className="mt-14 grid gap-12">
            {sections.map((section) => (
              <section key={section.heading}>
                <h2 className="text-[1.4375rem]">{section.heading}</h2>
                <div className="mt-4">
                  <Paragraphs text={section.body} className="text-[0.9375rem]" />
                </div>
              </section>
            ))}

            <section>
              <h2 className="text-[1.4375rem]">9. お問い合わせ窓口</h2>
              <div className="mt-4 rounded-card bg-mist p-8 text-[0.9375rem] max-[960px]:p-6">
                <p>
